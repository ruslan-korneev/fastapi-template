...
{% if cookiecutter.github_username and cookiecutter.ci_platform == 'github' %}
...
{% if cookiecutter.license != 'None' %}[![License: {{ cookiecutter.license }}](https://img.shields.io/badge/License-{{ cookiecutter.license | replace('-', '--') }}-yellow.svg)](https://opensource.org/licenses/{{ cookiecutter.license }}){% endif %}
